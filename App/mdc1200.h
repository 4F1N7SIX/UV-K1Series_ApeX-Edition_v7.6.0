...
/**
 * Decode a raw MDC-1200 frame from the 13-word RX FIFO representation produced by
 * the BK4819/BK4829 hardware. This is the actual receive-side path used when the
 * radio reads words from BK4819_REG_5F.
 */
