...
extern uint16_t              gMdcLastUnitId;
extern char                  gMdcDecodedId[16];
extern uint8_t               gMdcDecodeCountdown_500ms;
extern uint16_t              gMdcRxBuffer[MDC1200_FIFO_WORD_COUNT];
extern uint8_t               gMdcRxIndex;
#ifdef ENABLE_NOAA
